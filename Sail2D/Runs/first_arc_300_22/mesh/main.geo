...
//AIRFOIL DIMENSIONS
CHORDS[] = {BASEDIM};
ANGLES[] = {22*dtr};//angles of attack for each element.
...
BBCL = 0.04*BBDIM;//bounding box characteristic length.
...
For i In {0:NE-1}
	...
	points[] = {arccenter,splinepoints[],leblpoints[],teblpoints[],topblsplinepoints[],bottomblsplinepoints[]};rc[] = {LEX[i]+CHORDS[i]*0.25,LEY[i],0};angle = -ANGLES[i];Call rotatePoints2D;
